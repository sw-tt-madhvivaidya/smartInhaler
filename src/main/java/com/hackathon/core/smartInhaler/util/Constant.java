package com.hackathon.core.smartInhaler.util;

public class Constant {

    public static final String authAppUrl = "authpoc.iotconnect.io";
    public static final String userAppUrl = "userpoc.iotconnect.io";
